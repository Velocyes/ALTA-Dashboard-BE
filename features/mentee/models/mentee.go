...
type Mentee struct {
	...
	Logs      []lm.Log
	Status    string `gorm:"type:enum('Interview', 'Continue Unit 1','Continue Unit 2','Continue Unit 3' , 'Graduated', 'Eliminated', 'Join Class', 'Placement', 'Repeat Unit 1', 'Repeat Unit 2', 'Repeat Unit 3')"`
}
