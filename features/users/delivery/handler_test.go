...
// var BASE_URL = "http://localhost:8081/users"
...
// 			//mock helper
// 			mockHelper := new(mocks.Helper_)
// 			mockHelper.On("ExtractIDParam", mock.Anything).Return(1, nil)
...
// 			//mock service
// 			mockUserService := new(mocks.UserService_)
// 			mockUserService.On("Remove", mock.AnythingOfType("int"), mock.AnythingOfType("uint"), mock.AnythingOfType("string"), mock.Anything).Return(nil)
// 			mockUserService.On("Remove", mock.AnythingOfType("int"), mock.AnythingOfType("uint"), mock.AnythingOfType("string"), mock.Anything).Return(errors.New(consts.SERVER_ForbiddenRequest))
// 			mockUserService.On("Remove", mock.AnythingOfType("int"), mock.AnythingOfType("uint"), mock.AnythingOfType("string"), mock.Anything).Return(gorm.ErrRecordNotFound)

// 			//create new echo context
// 			req := httptest.NewRequest(http.MethodDelete, fmt.Sprintf("%s/%v", BASE_URL, v.Input.UserID), nil)
// 			rec := httptest.NewRecorder()

// 			//register endpoint
// 			e := echo.New()
// 			userDelivery := New(mockUserService, jwtMid)
// 			e.DELETE("classes/:id", userDelivery.RemoveAccount)
