...
// GetAll provides a mock function with given fields: queryParams, limit, offset
func (_m *UserService_) GetAll(queryParams url.Values, limit int, offset int) (map[string]interface{}, error) {
	ret := _m.Called(queryParams, limit, offset)

	var r0 map[string]interface{}
	var r1 error
	if rf, ok := ret.Get(0).(func(url.Values, int, int) (map[string]interface{}, error)); ok {
		return rf(queryParams, limit, offset)
	}
	if rf, ok := ret.Get(0).(func(url.Values, int, int) map[string]interface{}); ok {
	...
	if rf, ok := ret.Get(1).(func(url.Values, int, int) error); ok {
